#!/usr/bin/env bash
# Usage: ./web_viewer/bundle-viewer.sh <dfy-file> <output-dir>
...
mkdir -p "$OUT_DIR"
cp web_viewer/index.html web_viewer/app.js web_viewer/styles.css web_viewer/spans_provider.js "$OUT_DIR/"
