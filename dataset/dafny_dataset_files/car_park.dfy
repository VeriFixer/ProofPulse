class {:autocontracts} CarPark {
    ...
    constructor()
    requires true //:: Line found to be redundant in Proof coverage extraction
    ...
    ghost predicate Valid() //:: Ensure clause not used this is from autocontracts: car_park.dfy(29,21)-(29,21): ensures clause
    reads this
    {
  ...
  method checkAvailability() returns (availableSpaces: int)
    requires true //:: Found to be unused by proof so redundant!
    modifies this
  ...
  method closeCarPark()
    requires true //:: Found to be unused by proof
    modifies this
  ...
  method enterCarPark(car: string) returns (success: bool)
    ...
    } //:: car_park.dfy(136,5)-(136,5): out-parameter 'success', which is subject to definite-assignment rules, is always initialized 
  ...
  } //:: Not used car_park.dfy(163,3)-(163,3): out-parameter 'success', which is subject to definite-assignment rules, is always initialized at this return point
}
...
//::: Mains are weird MainB Still need to unsersatnd why but not priority
    // Unused by proof:
    //   car_park.dfy(237,15)-(237,31): call
    //   car_park.dfy(237,15)-(237,31): assignment (or return)
    //   car_park.dfy(241,3)-(241,29): call
    //   car_park.dfy(245,15)-(245,54): call
    //   car_park.dfy(245,15)-(245,54): assignment (or return)
    //   car_park.dfy(246,10)-(246,116): assert statement
    //   car_park.dfy(249,3)-(249,25): call
    //   car_park.dfy(250,10)-(250,94): assert statement
//:::