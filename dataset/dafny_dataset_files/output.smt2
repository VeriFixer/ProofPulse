...
(assert (! $generated@@92 :named aux$$assume$$id6))
(declare-fun $generated@@93 () Int)
(declare-fun $generated@@94 () Bool)
(assert (! $generated@@94 :named aux$$assert$$id7))
(declare-fun $generated@@95 () Bool)
(assert (! $generated@@95 :named aux$$assert$$id5))
...
(assert (! $generated@@99 :named aux$$assume$$id4))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let (($generated@@101  (=> (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false))  (=> $generated@@92 (= $generated@@93 ($generated 32)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) $generated@@94) (=> (= (ControlFlow 0 2) (- 0 1))  (and $generated@@95 (= $generated@@93 ($generated 32))))))))
(let (($generated@@102  (=> (and (and (and ($generated@@96 $generated@@90) ($generated@@97 $generated@@90)) (= 0 $generated@@98)) (and  (=> $generated@@99 (< $generated@@100 10)) (= (ControlFlow 0 4) 2))) $generated@@101)))
$generated@@102)))
))
(check-sat)
(get-info :rlimit)
