...
procedure {:verboseName "ret32 (well-formedness)"} CheckWellFormed$$_module.__default.ret32() returns (x#0: int);
  modifies $Heap;
...
procedure {:verboseName "ret32 (call)"} Call$$_module.__default.ret32() returns (x#0: int);
  ...
  ensures {:id "id1"} LitInt(3) == LitInt(3);
...
procedure {:verboseName "ret32 (correctness)"} Impl$$_module.__default.ret32() returns (defass#x#0: bool, x#0: int, $_reverifyPost: bool);
  modifies $Heap;
  // user-defined postconditions
  free ensures {:always_assume} true;
  ensures {:id "id2"} LitInt(3) == LitInt(3);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ret32 (correctness)"} Impl$$_module.__default.ret32() returns (defass#x#0: bool, x#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    assume {:captureState "test_post_cov_unc.dfy(3,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/tests/test_post_cov_unc/test_post_cov_unc.dfy(4,7)
    assume true;
    assume true;
    x#0 := LitInt(32);
    defass#x#0 := true;
    assume {:captureState "test_post_cov_unc.dfy(4,11)"} true;
    assert {:id "id4"} defass#x#0;
}
