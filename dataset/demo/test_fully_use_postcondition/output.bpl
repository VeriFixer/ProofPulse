...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ret32 (correctness)"} Impl$$_module.__default.ret32(a#0: int) returns (defass#x#0: bool, x#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    assume {:captureState "test_fully_use_postcondition.dfy(3,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/ricostynha/Desktop/ProofPulse/dataset/tests/test_fully_use_postcondition/test_fully_use_postcondition.dfy(4,7)
    assume true;
    assume true;
    x#0 := LitInt(32);
    defass#x#0 := true;
    assume {:captureState "test_fully_use_postcondition.dfy(4,11)"} true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var a##0: int;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assume {:captureState "test_fully_use_postcondition.dfy(6,14): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- /home/ricostynha/Desktop/ProofPulse/dataset/tests/test_fully_use_postcondition/test_fully_use_postcondition.dfy(7,16)
    assume true;
    ...
    n#0 := $rhs##0;
    assume {:captureState "test_fully_use_postcondition.dfy(7,18)"} true;
    // ----- assert statement ----- /home/ricostynha/Desktop/ProofPulse/dataset/tests/test_fully_use_postcondition/test_fully_use_postcondition.dfy(8,5)
    assume true;
