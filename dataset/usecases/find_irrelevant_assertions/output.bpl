...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Abs (correctness)"} Impl$$_module.__default.Abs(x#0: int) returns (defass#y#0: bool, y#0: int, $_reverifyPost: bool)
{
  ...
  var ##a#1_0: int;
    ...
    assume {:captureState "_USECASE_find_irrelevant_assertions.dfy(4,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assert statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_assertions/_USECASE_find_irrelevant_assertions.dfy(5,3)
    assume true;
    assert {:id "id10"} LitInt(43) == LitInt(43);
    // ----- if statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_assertions/_USECASE_find_irrelevant_assertions.dfy(8,3)
    assume true;
    if (x#0 < 0)
    {
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_assertions/_USECASE_find_irrelevant_assertions.dfy(9,7)
        assume true;
        assume true;
        y#0 := 0 - x#0;
        defass#y#0 := true;
        assume {:captureState "_USECASE_find_irrelevant_assertions.dfy(9,11)"} true;
    }
    else
    {
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_assertions/_USECASE_find_irrelevant_assertions.dfy(11,7)
        assume true;
        ##a#1_0 := x#0;
        ...
        defass#y#0 := true;
        assume {:captureState "_USECASE_find_irrelevant_assertions.dfy(11,14)"} true;
    }
