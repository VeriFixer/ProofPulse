...
(assert (! $generated@@95 :named aux$$assert$$id10))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let (($generated@@96  (=> (and (and (and ($generated@@88 $generated@@89) ($generated@@90 $generated@@89)) (= 1 $generated@@91)) (and (= $generated@@92 ($generated@@29 $generated@@93 $generated@@89 $generated@@94 false)) (= (ControlFlow 0 2) (- 0 1))))  (and $generated@@95 (= ($generated 43) ($generated 43))))))
$generated@@96))
))
(check-sat)
(get-info :rlimit)
