...
procedure {:verboseName "Abs (call)"} Call$$_module.__default.Abs(x#0: int) returns (y#0: int);
  ...
  free ensures true;
  ensures {:id "id1"} LitInt(4) == LitInt(4);
...
procedure {:verboseName "Abs (correctness)"} Impl$$_module.__default.Abs(x#0: int) returns (defass#y#0: bool, y#0: int, $_reverifyPost: bool);
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id2"} LitInt(4) == LitInt(4);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Abs (correctness)"} Impl$$_module.__default.Abs(x#0: int) returns (defass#y#0: bool, y#0: int, $_reverifyPost: bool)
{
  ...
  var ##a#1_0: int;
    ...
    assume {:captureState "_USECASE_irrelevant_postconditions.dfy(3,0): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_postconditions/_USECASE_irrelevant_postconditions.dfy(4,3)
    assume true;
    if (x#0 < 0)
    {
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_postconditions/_USECASE_irrelevant_postconditions.dfy(5,7)
        assume true;
        assume true;
        y#0 := 0 - x#0;
        defass#y#0 := true;
        assume {:captureState "_USECASE_irrelevant_postconditions.dfy(5,11)"} true;
    }
    else
    {
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_postconditions/_USECASE_irrelevant_postconditions.dfy(7,7)
        assume true;
        ##a#1_0 := x#0;
        ...
        defass#y#0 := true;
        assume {:captureState "_USECASE_irrelevant_postconditions.dfy(7,15)"} true;
    }

    assert {:id "id5"} defass#y#0;
}
