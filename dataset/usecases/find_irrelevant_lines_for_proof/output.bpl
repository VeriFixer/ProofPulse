...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Abs (correctness)"} Impl$$_module.__default.Abs(x#0: int) returns (defass#y#0: bool, y#0: int, $_reverifyPost: bool)
{
  ...
  var ##a#2_0: int;
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_lines_for_proof/_USECASE_find_irrelevant_lines_for_proof.dfy(5,3)
    assume true;
    if (x#0 == LitInt(0))
    {
        push;
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_lines_for_proof/_USECASE_find_irrelevant_lines_for_proof.dfy(6,7)
        assume true;
        assume true;
        y#0 := LitInt(0);
        defass#y#0 := true;
    ...
    // ----- if statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_lines_for_proof/_USECASE_find_irrelevant_lines_for_proof.dfy(9,3)
    assume true;
    if (x#0 < 0)
    {
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_lines_for_proof/_USECASE_find_irrelevant_lines_for_proof.dfy(10,7)
        assume true;
        assume true;
        y#0 := 0 - x#0;
        defass#y#0 := true;
    ...
    {
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_irrelevant_lines_for_proof/_USECASE_find_irrelevant_lines_for_proof.dfy(12,7)
        assume true;
        ##a#2_0 := x#0;
