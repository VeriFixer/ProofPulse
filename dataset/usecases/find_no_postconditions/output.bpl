...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Abs (correctness)"} Impl$$_module.__default.Abs(x#0: int) returns (defass#y#0: bool, y#0: int, $_reverifyPost: bool)
{
  ...
  var ##a#1_0: int;
    ...
    assume {:captureState "_USECASE_no_postconditions.dfy(2,0): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_no_postconditions/_USECASE_no_postconditions.dfy(3,3)
    assume true;
    if (x#0 < 0)
    {
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_no_postconditions/_USECASE_no_postconditions.dfy(4,7)
        assume true;
        assume true;
        y#0 := 0 - x#0;
        defass#y#0 := true;
        assume {:captureState "_USECASE_no_postconditions.dfy(4,11)"} true;
    }
    else
    {
        // ----- assignment statement ----- /home/ricostynha/Desktop/drive/ProjectBase/projects/drive.ProjectBase/code/ProofPulse/dataset/usecases/find_no_postconditions/_USECASE_no_postconditions.dfy(6,7)
        assume true;
        ##a#1_0 := x#0;
        ...
        defass#y#0 := true;
        assume {:captureState "_USECASE_no_postconditions.dfy(6,14)"} true;
    }

    assert {:id "id2"} defass#y#0;
}
